...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_table(u'producttracker_product', (
            ...
            ('is_discontinued', self.gf('django.db.models.fields.BooleanField')(default=False)),
            ...
            ('has_bonus_reward_miles', self.gf('django.db.models.fields.BooleanField')(default=False)),
        ...
        db.create_table(u'producttracker_storeinventory', (
            ...
            ('updated_on', self.gf('django.db.models.fields.DateField')()),
            ('created', self.gf('django.db.models.fields.DateTimeField')(auto_now_add=True, blank=True)),
        ))
    ...
    models = {
        u'producttracker.product': {
            ...
            'has_bonus_reward_miles': ('django.db.models.fields.BooleanField', [], {'default': 'False'}),
        ...
        u'producttracker.storeinventory': {
            ...
            'updated_on': ('django.db.models.fields.DateField', [], {})
        },
